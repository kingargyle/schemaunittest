 ...
 *   License.
 *   
 *   The Original Code is  org.starstandard.junit.test.resources.common.TestBODSBase.java
 *   
...
public class TestBODSBase extends XMLTestCase {

	private String nounFileName = StarPropertiesLoader.getStarPath("MainSTARPath")
	...
	public TestBODSBase(String name) {
		super(name);
	}

	protected void setUp() {
		try {
			component.getSchemaFile(nounFileName);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
