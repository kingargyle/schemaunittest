 ...
 *   License.
 *   
 *   The Original Code is  org.starstandard.junit.test.resources.common.TestNounBase.java
 *   
...
public class TestNounBase extends XMLTestCase {

	private String nounFileName = StarPropertiesLoader
	...
	public TestNounBase(String name) {
		super(name);
	}
